        	...
        	try {
    	    	class DetailsPanel extends javax.swing.JFrame {
    	    	    ...
    	    	    private void initComponents() {
    	    	        ...
    	    	        jLabel3.setText("Employee's RG:     " + employeeList.getSelectedValue().getRg());
    	
    	    	        jLabel4.setText("Employee's Address:     " + employeeList.getSelectedValue().getAddress());
    	
    	    	        jLabel5.setText("Employee's Phone:     " + employeeList.getSelectedValue().getPhone());
    	
    	    	        jLabel6.setText("Employee's Birthday:     " + employeeList.getSelectedValue().getBirthday());
    	
    	    	        jLabel2.setText("Employee's CPF:     " + employeeList.getSelectedValue().getCpf());
