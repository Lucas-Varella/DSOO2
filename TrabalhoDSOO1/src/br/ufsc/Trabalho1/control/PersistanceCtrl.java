...
public class PersistanceCtrl {
	...
	public PersistanceCtrl() {
		...
		add(new Staff("23123", "123", "ddddd", "2112", "rua " ,"9999999", Positions.ADMIN, "12233", "admin", "admin"));
		add(new Staff("24214", "124", "aaaaa", "2113", "rei", "99999999" , Positions.INSTRUCTOR, "13333", "employee", "employee"));
